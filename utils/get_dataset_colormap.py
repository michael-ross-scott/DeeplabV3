...
_PASCAL = 'pascal'
_AEROBOTICS_INFORMATION = 'Aerobotics'
...
_DATASET_MAX_ENTRIES = {
    ...
    _PASCAL: 256,
    _AEROBOTICS_INFORMATION: 4,
}

def create_aero_label_colormap():
    print("----------------I GOT HERE-------------------------")
    colormap = np.zeros((256, 3), dtype=np.uint8)
    colormap[0] = [0,0,0] # BLACK - BACKROUND
    colormap[1] = [10,18,251] #  BLUE - NOT TREE
    colormap[2] = [60,255,120] # GREEN - TREE
    colormap[255] = [255,255,255] # WHITE - IGNORE LABEL
    return colormap
...
def get_aero_name():
    return _AEROBOTICS_INFORMATION
...
def create_label_colormap(dataset=_PASCAL):
  ...
  elif dataset == _AEROBOTICS_INFORMATION:
    return create_aero_label_colormap()
  else:
